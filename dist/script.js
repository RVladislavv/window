...
window.addEventListener('DOMContentLoaded', function () {
  'use strict'; //для расчёта в калькуляторе

  var modalState = {};
  Object(_modules_changeModalState__WEBPACK_IMPORTED_MODULE_4__["default"])(modalState);
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])(); //1 и 2 п
  //5 п headerSelector, tabSelector, contentSelector, activeClass

  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.glazing_slider', '.glazing_block', '.glazing_content', 'active'); //7 п

  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.decoration_slider', '.no_click', '.decoration_content > div > div', 'after_click'); //10 п временно отключен в modals
  //6

  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.balcon_icons', '.balcon_icons_img', '.big_img > img', 'do_image_more', 'inline-block');
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"])(modalState); //3 4 6
  ...
  function bindActionToElems(event, elem, prop) {
    elem.forEach(function (item, i) {
      item.addEventListener(event, function () {
        //проверям элемент на ноду, чтоб понимать с чем работаем
...
var checkNumInputs = function checkNumInputs(selector) {
  var numInputs = document.querySelectorAll(selector); //проверка, чтоб вводились именно цифры
...
var forms = function forms(state) {
  ...
  var inputs = document.querySelectorAll('input'); //проверка, чтоб вводились именно цифры(через регулярку остальное удалятся будет)

  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_5__["default"])('input[name="user_phone"]'); //селектор форм с вводом телефонов
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      item.appendChild(messageDiv); //объект Форма

      var formData = new FormData(item);

      if (item.getAttribute('data-calc') === 'end') {
        //Отправка итогового окна из калькулятора
      ...
      postData('assets/server.php', formData).then(function (res) {
        ...
        return messageDiv.textContent = message.fail;
      }).finally(function () {
        clearValue();
        setTimeout(function () {
          messageDiv.remove();
...
var modals = function modals() {
  ...
  function modal(openSelector, modalSelector, closeSelector) {
    ...
    var mod = document.querySelector(modalSelector);
    var close = document.querySelector(closeSelector);
    var windows = document.querySelectorAll('[data-modal]'); //передача дата атрибута, чтоб закрыть все окна
    ...
    open.forEach(function (item) {
      ...
      item.addEventListener('click', function (e) {
        ...
        mod.style.display = 'block'; //чтоб не листалось всё для бади сделать стайл оверфлоу в хайдн
    ...
    mod.addEventListener('click', function (e) {
      ...
      if (e.target === mod && closeClickOverlay) {
        //последнее - параметр, если не надо закрывать
        windows.forEach(function (item) {
          item.style.display = 'none';
        });
        mod.style.display = 'none';
  ...
  function showModalAfterOpen(selector, time) {
    setTimeout(function () {
      var module = document.querySelector(selector);
  ...
  modal('.popup_engineer_btn', '.popup_engineer', '.popup_engineer .popup_close'); //2 пункт

  modal('.phone_link', '.popup', '.popup_close'); //10 пункт
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  var content = document.querySelectorAll(contentSelector); //5 и 7 пункты
  ...
  function showTabContent() {
    ...
    tab[i].classList.add(activeClass); //у i-того элемента из массива контента ставим дисплей блок
  ...
  header.addEventListener('click', function (e) {
    var el = e.target;
    var elClass = tabSelector.replace(/\./, ''); //убираем точку перед классом через регулярку
